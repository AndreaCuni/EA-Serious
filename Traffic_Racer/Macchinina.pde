class Macchinina{      // classe della macchinina protagonista che gestisce i movimenti base 
    ...
    public void move(float x){
      ...
      if (x > COLONNA_3_LIM_DX && x < COLONNA_4_LIM_DX){     
        setX(COLONNA_1);                                        
      }else{
        if(x > COLONNA_2_LIM_DX && x < COLONNA_3_LIM_DX ){       
          setX(COLONNA_2);                                 
        }else{
           if(x > COLONNA_2_LIM_SX && x < COLONNA_2_LIM_DX ){  
             setX(COLONNA_3);                                   
           }else{
             setX(COLONNA_4);                                 
           }    
    ...
    public void show(){
      ...
      image(macchina,x,y,DIM_SHOW_X,DIM_SHOW_Y);      
